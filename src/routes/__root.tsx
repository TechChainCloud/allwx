  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "All Weather Terminal. Bridgewater-inspired portfolio classroom. Four regimes, seven sleeves, Bloomberg functions as the measurement system. Education only.",
      },
