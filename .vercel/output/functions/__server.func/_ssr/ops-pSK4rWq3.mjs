//#region node_modules/.nitro/vite/services/ssr/assets/ops-pSK4rWq3.js
var DESK_ASOF = "2026-09-09";
var DESK_CLOCK = "17:35 BST";
var DESK_EVENT = "Thu 10 Sep CPI 13:30 · 16 Sep FOMC";
var SEVEN_TONIGHT = [
	{
		n: 1,
		q: "Cycle stage?",
...
var DRAWDOWN = [
	{
		...
		action: "No sleeve changes. Run the Seven Questions. Confirm the regime has not rotated. Document the chain. Do not add to losers."
	},
	{
		level: "AMBER",
...
var META = "Weight adjustments are the machine running. Instrument additions are the machine being upgraded. The machine runs on a monthly clock. Upgrades run on a multi-year clock, triggered by book size, not by a loud week. The most dangerous moment is a good year — when the working sleeves beg to be enlarged. The machine rebalances away from winners. That rule has to exist before the temptation.";
//#endregion
export { SKELETON_RIGHT as _, DESK_EVENT as a, FOMC as c, MILESTONES as d, POSTURES as f, SKELETON_GAPS as g, SEVEN_TONIGHT as h, DESK_CLOCK as i, GATES as l, SCORECARD as m, CANDIDATES as n, DRAWDOWN as o, RHYTHM as p, DESK_ASOF as r, DRIFT_RULES as s, BASE_WEIGHTS as t, META as u, WATCH as v, weightsFor as y };
